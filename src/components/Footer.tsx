...
const Footer = () => {
  return (
    <div className="w-full border-t-2 flex justify-center">
      <div className="w-full max-w-[950px] max-lg:max-w-[540px] max-sm:max-w-[350px] h-auto min-h-[250px] flex flex-col lg:flex-row gap-6 max-sm:gap-6 sm:gap-4 items-center justify-center my-10 px-4">
